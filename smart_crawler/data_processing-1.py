...
✓ Writes to `outputs/processed/` as JSON

Run:
```bash
python -m smart_crawler.data_processor
```
"""
...
from smart_crawler.schema import PageContent, Section  # already built
...
if llm:
    def summarise(text: str) -> str:
        # TODO: upgrade to PromptTemplate later
        prompt = (
            "You are a senior technical writer. Based on the section below, generate a concise markdown summary keeping key info, CTAs, and structure.\n\n"
            + text
        )
        try:
